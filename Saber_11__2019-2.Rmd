...
barplot(table(a)[2:length(summary(a))], ylab = "Frecuencia", las = 3, 
        main = "Departamentos 2019-II", col = rainbow(length(summary(a))))
```
```{r}
...
pie(x5, labels = labels5, radius = 1.4, main = "PUNTAJES GLOBALES 2019-II", col = rainbow(length(x5)))
...
summary(areas)
boxplot(areas, main = "PUNTAJES GLOBALES 2019-II", horizontal = FALSE, border = "black", col = rev(rainbow(length(areas))), las = 2)
```
